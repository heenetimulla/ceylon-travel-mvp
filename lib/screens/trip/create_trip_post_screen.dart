...
class _CreateTripPostScreenState extends State<CreateTripPostScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppPageAppBar(title: const Text('Create Trip / Hire Post')),
      body: SafeArea(
        child: ListView(
          padding: appPagePadding(context),
          children: [
            const Text('Create Trip / Hire Post', style: AppTextStyles.title),
            ...
            AppInfoCard(
              children: [
                const AppSectionHeader('Passengers & baggage'),
                CounterRow(
                  label: 'Adults',
                  value: adults,
                  onMinus: () {
            ...
            FilledButton.icon(
              ...
              label: Text(_isSaving ? 'Saving...' : 'Post Trip / Hire'),
            ),
          ],
        ),
      ),
